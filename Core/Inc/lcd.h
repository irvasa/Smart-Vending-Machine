...
#define LCD16X2_GPIO_DATA					GPIOD
#define LCD16X2_GPIO_D4						GPIOD
#define LCD16X2_GPIO_D5						GPIOD
#define LCD16X2_GPIO_D6						GPIOD
#define LCD16X2_GPIO_D7						GPIOD
// Pin definition
#define LCD16X2_PIN_RS	GPIO_PIN_10
#define LCD16X2_PIN_RW	GPIO_PIN_11
#define LCD16X2_PIN_EN	GPIO_PIN_12
#define LCD16X2_PIN_D4	GPIO_PIN_2		// 4-bit mode LSB
#define LCD16X2_PIN_D5	GPIO_PIN_3
#define LCD16X2_PIN_D6	GPIO_PIN_4
...
/** Delay value ------------------------------------------------------------- */
// Delay power on
#define LCD16X2_DELAY_POWER_ON   		16
// Delay after initialize 8-bit
#define LCD16X2_DELAY_INIT      		5
